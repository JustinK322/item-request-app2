...
class ItemRequestsControllerTest < ActionController::TestCase
  ...
  test "should create item_request" do
    assert_difference('ItemRequest.count') do
      post :create, item_request: { approvedBy: @item_request.approvedBy, approvedOn: @item_request.approvedOn, isApproved: @item_request.isApproved, itemName: @item_request.itemName, price: @item_request.price, reason: @item_request.reason }
    end
  ...
  test "should update item_request" do
    patch :update, id: @item_request, item_request: { approvedBy: @item_request.approvedBy, approvedOn: @item_request.approvedOn, isApproved: @item_request.isApproved, itemName: @item_request.itemName, price: @item_request.price, reason: @item_request.reason }
    assert_redirected_to item_request_path(assigns(:item_request))
  end
